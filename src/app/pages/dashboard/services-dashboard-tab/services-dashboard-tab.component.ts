...
@Component({
  ...
  templateUrl: './services-dashboard-tab.component.html',
  styleUrl: './services-dashboard-tab.component.scss'
})
export class ServicesDashboardTabComponent {
  ...
  const filteredSales = sales.filter(sale => {
    ...
    return saleYear === currentYear && sale.branch === "Services";
  });
